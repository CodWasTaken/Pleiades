...
Verification commands run as background runtime tasks. They detect project
tooling, inspect the diff, execute bounded checks, and emit structured evidence
